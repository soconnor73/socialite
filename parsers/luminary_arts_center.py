...
class LuminaryArtsCenterParser(BaseParser):
    """
    Parser for the Luminary Arts Center events calendar.
    URL: https://luminaryartscenter.com/events/
    ...
    def _parse_api_event(self, ev: Dict) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            'venue': venue,
            'title': name,
            'tour': 'Luminary Arts Center Event',

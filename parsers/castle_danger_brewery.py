...
class CastleDangerBreweryParser(BaseParser):
    """
    Parser for Castle Danger Brewery events.
    URL: https://castledangerbrewery.com/music-events/
    This site uses The Events Calendar (Tribe) WordPress plugin.
    Exposes Tribe's public REST API at:
